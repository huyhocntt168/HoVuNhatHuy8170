...
public class EmailUtils {
	...
	public EmailUtils(EmailFolder emailFolder) throws MessagingException {
		this(getEmailUsernameFromProperties(), getEmailPasswordFromProperties(), getEmailServerFromProperties(),
				emailFolder);
	}
	...
	public EmailUtils(String username, String password, String server, EmailFolder emailFolder)
		...
		try {
			props.load(new FileInputStream(new File("Common/utils/email.properties")));
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(-1);
		}
	...
	public static String getLinkWithinMail() {
		try {
			emailUtils = new EmailUtils(Constant.USERNAME_ACTIVATION, Constant.PASSWORD_ACTIVATION, "smtp.gmail.com",
